...
\begin{table*}[t]
\centering
\caption{Cross-modal predicate quality averaged over three strict splits, with packed storage accounting. For PQ64, the first number is the persistent linear head; the second is the materialized active LUT used by the native executor.}
\label{tab:predicate_finalists}
\small
\begin{tabular}{lrrrr}
\toprule
Method & Item B & Program B (stored/active) & Mean F1 & Mean AP\\
\midrule
FP32 linear & 1536 & 1548 & \textbf{.745} & \textbf{.805}\\
PQ64 compiled linear & 64 & 1548 / 65548 & .737 & .794\\
